...
public class TicTacToeVsComputerF {
	 ...
	 * 
	 * if(playerScore == 3){ board[0][2] = 'O'; } else if (playerScore ==)
	 * 
	 * }
	 */
	...
	public static void checkScoreUser(Scanner console) {
		if (aiScore == 3201 || aiScore == 1203 || aiScore == 6 || aiScore == 600 || aiScore == 6000 || aiScore == 1101
				|| aiScore == 2202 || aiScore == 3303) {
			System.out.println("I win!!! Hahahahahaha!!!!!!");
			intro();

		} else if (playerScore == 3201 || playerScore == 1203 || playerScore == 6 || playerScore == 600
				|| playerScore == 6000 || playerScore == 1101 || playerScore == 2202 || playerScore == 3303) {
